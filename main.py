...
game_window = Tk()
game_window.title("Rock Paper Scissors Game - Neeraj")
game_window.iconbitmap(r'C:\Users\neera\OneDrive\It one drive\OneDrive\Desktop\python projects\rock paper scissors\stone paper scissor icon.ico')
